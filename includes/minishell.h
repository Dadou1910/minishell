...
/*   Updated: 2024/12/16 18:31:51 by jealefev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					handle_remaining_chars(const char *input,
							t_indices *indices, t_state *state);
...
int						execute_cmd2(t_command *cmd);
...
int						*process_tokens_fd(char **tokens, int *fds, char *str,
							char **envp);
...
void					signal_print_off(void);
int						ft_check_export(char **args);
