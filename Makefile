...
BUILTINS_SRC    = $(BUILTINS_DIR)/builtins.c $(BUILTINS_DIR)/cd.c $(BUILTINS_DIR)/echo.c \
                  ...
                  $(BUILTINS_DIR)/unset.c $(BUILTINS_DIR)/exit.c $(BUILTINS_DIR)/help_built.c
EXEC_SRC        = $(EXEC_DIR)/checks.c $(EXEC_DIR)/execute.c $(EXEC_DIR)/free.c \
                  $(EXEC_DIR)/main.c $(EXEC_DIR)/path.c $(EXEC_DIR)/pids.c \
				  $(EXEC_DIR)/pipe.c $(EXEC_DIR)/print_utils.c \
...
PARSING_SRC     = $(PARSING_DIR)/env_and_ressources.c $(PARSING_DIR)/parsing_utils.c \
				  ...
				  $(PARSING_DIR)/get_in_fds.c $(PARSING_DIR)/get_in_fds2.c \
				  $(PARSING_DIR)/heredoc_parsing.c 
